...
#for news updates
def news():
    main_url = 'http://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=8e702537146f47cca9d9d9845e29c491'
...
if __name__ == "__main__": #main program
    ...
    # if 1:
        ...
        if "open notepad" in query:
            ...
            kit.sendwhatmsg("+916260774183", "this is testing protocol",4,13)
            time.sleep(120)
...
###########################################################################################################################################
        ...
        elif "email to Sonendra" in query:
               
            speak("sir what should i say")
            query = takecommand().lower()
            if "send a file" in query:
                email = 'sonendrasingh36@gmail.com' # Your email
                password = 'Sonendra@19' # Your email account password
                send_to_email = 'sonendra101singh@gmail.com' # Whom you are sending the message to
                ...
                server.quit()
                speak("email has been sent to Sonendra")
        ...
        #..............to check instagram profile
            ...
            if "yes" in condition:
                ...
                speak("i am done sir, profile poicture is saved in our main folder. now i am ready for next command")
